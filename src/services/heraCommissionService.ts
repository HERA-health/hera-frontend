...
export interface AccountDetail { payableEntries?: PayableEntry[]; documentImportBlock?: string | null; summary: Balance; acceptances: Acceptance[]; specialistFiscal: { fiscalName: string | null; fiscalNif: string | null; fiscalAddress: string | null }; periods: Period[]; documents: DocumentBalance[]; cash: Cash[]; issues: Issue[]; hasMore: boolean }

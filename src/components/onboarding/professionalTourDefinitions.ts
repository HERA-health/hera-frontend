  ...
  professional_clinical_area_v1: {
    ...
    steps: [
      ...
      },
      {
        ...
        body: 'Este módulo reúne las dos vías. Firma digital de consentimiento clínico para pacientes con cuenta HERA y documento de consentimiento clínico para pacientes gestionados sin cuenta. Cuando se completa la vía que corresponde, el consentimiento queda vigente.',
        placement: 'bottom',
      },
      {
        ...
        body: 'Esta vía vive dentro del mismo módulo de consentimiento. Para pacientes gestionados, sube aquí el consentimiento clínico firmado por el paciente y regístralo para habilitar el tratamiento de datos clínicos.',
        placement: 'bottom',
      },
      {
        id: 'questionnaire',
